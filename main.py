...
def twoCameraImage():
    if(len(connected_devices) != 2 ):
        return redirect("/surveillance");
    return render_template("surveillance/two_camera_image.html", connected_cameras=wired_cameras, connected_devices=connected_devices );

@app.route("/surveillance/more-cameras-image")
def moreThanTwoCameraImage():
    if(len(connected_devices) == 0 or len(connected_devices) < 3 ):
        return redirect("/surveillance");
    return render_template("surveillance/more_cameras_image.html", connected_cameras=wired_cameras, connected_devices=connected_devices );
...
def noCamerasAdded():
    ...
    if(len(connected_devices) > 0 ):
        return redirect("/surveillance");
    return render_template("surveillance/surveillance.html", connected_cameras = wired_cameras, connected_devices=connected_devices );
